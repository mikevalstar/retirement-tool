...
import { Upload, RefreshCw, Play, TrendingUp, Clock, CalendarRange } from 'lucide-react'
    ...
    <div style={{ maxWidth: 960, display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ display: 'flex', gap: 14 }}>
        <StatCard
          ...
          value="$0"
          sub="No account balances recorded"
          icon={TrendingUp}
        ...
        <StatCard
          ...
          value="—"
          sub="Never run · click Run Simulation to start"
          icon={Clock}
          accent="var(--section-simulation)"
        />
        <StatCard
          label="Projected Retirement"
          value="—"
          sub="Run a simulation to see your range"
          icon={CalendarRange}
      ...
      <div>
        ...
        <div style={{ display: 'flex', gap: 14 }}>
          <QuickAction
            ...
            sub="Paste or drop a credit card CSV"
            accent="var(--section-expenses)"
            to="/expenses"
          />
          <QuickAction
            icon={RefreshCw}
          ...
          <QuickAction
            ...
            sub="Monte Carlo · generates percentile bands"
            accent="var(--section-simulation)"
            to="/simulation"
          />
        </div>
